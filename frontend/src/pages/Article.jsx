    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600">The article you're looking for doesn't exist or has been removed.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-3xl mx-auto py-6 sm:py-12 px-4 sm:px-6">
      <article className="prose prose-sm sm:prose-lg mx-auto w-full overflow-hidden">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-6 sm:mb-8 border-b border-gray-100 pb-6 sm:pb-8">
          <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-medium">
        ...
        <div className="prose prose-sm sm:prose-lg prose-gray mx-auto">
          {article.content.split('\n').map((paragraph, index) => (
            paragraph && (
              <p key={index} className="mb-4 text-gray-800 leading-relaxed break-words text-sm sm:text-base">
                {paragraph}
              </p>
            )
          ))}
